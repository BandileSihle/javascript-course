...
function renderTodoList() {
  ...
  const html = `
    ...
    <button onclick="
      todoList.splice(${i}, 1);
      localStorage.setItem('todoList', JSON.stringify(todoList)); // Dont use removeItem as it removes all todos
      // ensures localStorage is update with new todos
      renderTodoList(); // Re-render list
